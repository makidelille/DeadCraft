...
public class DeadCraftItems {
    ...
    public static void init() {
        ...
        compacted = new ItemCompacted().setUnlocalizedName(IBTInfos.ITEM_COMPACTED_KEY);
        ...
        GameRegistry.registerItem(compacted, IBTInfos.ITEM_COMPACTED_KEY, Lib.MOD_ID);
    }
    ...
    public static void registerCraftRecipe() {
        ...
        CraftingManager.getInstance().addRecipe(is, new Object[] { " R ", "RNR", " R ", Character.valueOf('R'), Items.redstone, Character.valueOf('N'), Items.nether_star });
        ...
        tag.setInteger("charge", 0);
        is.setTagCompound(tag);
        CraftingManager.getInstance().addRecipe(is, new Object[] { " C ", "CDC", " C ", Character.valueOf('C'), new ItemStack(crystal, 1, 0), Character.valueOf('D'), Items.diamond });
        ...
        tag.setInteger("charge", 0);
        is.setTagCompound(tag);
        CraftingManager.getInstance().addRecipe(is, new Object[] { "RCR", "CDC", "RCR", Character.valueOf('R'), Blocks.redstone_block, Character.valueOf('D'), Blocks.diamond_block, Character.valueOf('C'), new ItemStack(crystal, 1, 1) });
        
        /**
         * craft of wrench
         */
        is = new ItemStack(wrench);
        CraftingManager.getInstance().addRecipe(is, new Object[] { " T ", " TT", "B  ", Character.valueOf('T'), Blocks.redstone_torch, Character.valueOf('B'), Items.blaze_rod });
        /**
         * craft of godcan
         */
        is = new ItemStack(godCan);
        CraftingManager.getInstance().addRecipe(is, new Object[] { "III", "INI", " B ", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('N'), Items.nether_star, Character.valueOf('B'), Items.bucket, Character.valueOf('R'), Items.redstone });
        /**
        ...
        tag.setInteger("charge", 0);
        is.setTagCompound(tag);
        CraftingManager.getInstance().addRecipe(is, new Object[] { " T ", "ICI", "II ", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('T'), Blocks.redstone_torch, Character.valueOf('C'), crystal });
        /**
         * craft of Deadwand
         */
        ...
        tag.setInteger("charge", 0);
        is.setTagCompound(tag);
        CraftingManager.getInstance().addRecipe(is, new Object[] { " RN", " GR", "D  ", Character.valueOf('R'), Items.redstone, Character.valueOf('N'), Items.nether_star, Character.valueOf('D'), Items.diamond });
