...
public class GuiGodBottler extends GuiCustom {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int mouseX, int mouseY) {
        ...
        subRect.add(0, new GuiRectangle(this, 71, 23, 4, getSizeBar(0))); // vertical
                                                                          // l
        subRect.add(1, new GuiRectangle(this, 139, 23, 4, getSizeBar(1))); // vertical
                                                                           // r
        subRect.add(2, new GuiRectangle(this, 71, 45, getSizeBar(2), 4)); // horizontal
                                                                          // r
        subRect.add(3, new GuiRectangle(this, 107 + 36 - getSizeBar(3), 45, getSizeBar(3), 4)); // horizontal
                                                                                                // l
        subRect.add(4, new GuiRectangle(this, 102, 49, 12, getSizeBar(4))); // fleche
        subRect.add(5, new GuiRectangle(this, 16, 7 + 52 - getSizeBar(5), 18, getSizeBar(5))); // power
                                                                                               // bar
    ...
    private int getSizeBar(int i) {
        ...
        } else if (workedTime <= 5f * TileEntityGodBottler.BUILDTIME / 6f && workedTime > TileEntityGodBottler.BUILDTIME / 3f) {
            switch (i) {
                case 0:
                    return 22;
                case 1:
                    return 22;
                case 2:
                    return (int) (36 * (2 * x - 2f / 3f));
                case 3:
                    return (int) (36 * (2 * x - 2f / 3f));
                default:
                    return 0;
            }
        } else if (workedTime <= TileEntityGodBottler.BUILDTIME && workedTime > 5f * TileEntityGodBottler.BUILDTIME / 6f) {
            switch (i) {
                case 0:
                    return 22;
                case 1:
